class TimeSeries{
	...
	updateChart(){
		...
		vis.xAxisGroup.selectAll("text").attr("class", "text-muted").style("font-family", "cursive, sans-serif").style("font-size", "0.35rem");
		vis.yAxisGroup.selectAll("text").attr("class", "text-muted").style("font-family", "cursive, sans-serif").style("font-size", "0.35rem");
