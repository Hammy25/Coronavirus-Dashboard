...
import {formatData, determineTitle, formatTime, numbersWithCommas} from "./formating";
import {allCases} from "./drawing";
...
export default class BarChart{
	...
	updateChart(){
		...
		vis.xAxis.selectAll("text").attr("class", "text-muted").style("font-family", "'Open Sans', sans-serif").style("font-size", "0.35rem");
		vis.yAxis.selectAll("text").attr("class", "text-muted").style("font-family", "'Open Sans', sans-serif").style("font-size", "0.35rem");
		// Heading code
